    ...
    if (window.confirm('¿Estás seguro de que quieres eliminar este destino? Esta acción no se puede deshacer.')) {
      try {
        ...
        if (err instanceof Error) {
          ...
          setError('Error desconocido al eliminar el destino');
        }
      }
    }
  };
                  ...
                  <div className="relative h-48">
                    {article.image ? (
                      <Image
                        ...
                        onError={() => {
                          const target = document.querySelector(`img[alt='${article.title}']`) as HTMLImageElement;
                          if (target) target.src = '/images/destinos/default.jpg';
                        }}
                      />
                    ) : (
